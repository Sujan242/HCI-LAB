...
function draw(){
    ...
    if(state == 0){
        ...
        // textSize(16);
        textSize(20);
        text('1. Read the instruction that will be displayed above the canvas' , width/2 , 150);
        text('2. Execute the instruction by clicking on the appropriate circle' , width/2 , 200);
